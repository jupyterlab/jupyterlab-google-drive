...
import {
  IPathTracker
} from 'jupyterlab/lib/filebrowser/tracker';

import {
  IFileBrowserModel, FileBrowserModel
} from 'jupyterlab/lib/filebrowser/model';
 ...
 */
export
class GoogleFileBrowserModel implements IFileBrowserModel {
  /**

...
const fileBrowserPlugin: JupyterLabPlugin<IPathTracker> = {
  ...
  requires: [IDocumentRegistry, IRealtime, ILayoutRestorer, IStateDB],
 ...
 */
function activateFileBrowser(app: JupyterLab, registry: IDocumentRegistry, realtime: IRealtime, restorer: ILayoutRestorer, state: IStateDB): IPathTracker {
  let { commands } = app;
